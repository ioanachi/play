...
// module
exports.push([module.i, "body {\n  background: #F3F3F4;\n  color: #333;\n  padding: 20px; }\n  body form {\n    width: 400px;\n    margin: 0 auto; }\n    body form .input-holder {\n      position: relative;\n      margin: 0 0 20px; }\n      body form .input-holder span {\n        color: red; }\n      body form .input-holder input,\n      body form .input-holder textarea {\n        border: 2px solid #ccc;\n        border-radius: 4px;\n        padding: 10px;\n        width: 100%;\n        resize: none;\n        transition: 0.3s; }\n        body form .input-holder input:focus,\n        body form .input-holder textarea:focus {\n          border: 2px solid #999;\n          outline: none; }\n      body form .input-holder textarea {\n        min-height: 100px; }\n    body form .message {\n      position: absolute;\n      z-index: 9;\n      display: none;\n      width: 100%;\n      padding: 10px;\n      margin-top: 10px;\n      background: #D9585C;\n      color: #fff;\n      text-align: center; }\n      body form .message:after {\n        content: '';\n        position: absolute;\n        top: -10px;\n        left: 50%;\n        display: block;\n        margin-left: -10px;\n        border: solid;\n        border-color: #D9585C transparent #D9585C;\n        border-width: 0 10px 10px; }\n    body form .is-valid {\n      border-color: #AAD661 !important;\n      transition: 0; }\n    body form .not-valid {\n      border-color: #D7595F;\n      transition: 0; }\n      body form .not-valid + .message {\n        display: block !important; }\n    body form .submit {\n      display: block;\n      width: 100%;\n      padding: 10px;\n      border: 2px solid #ccc;\n      border-radius: 4px;\n      background: transparent;\n      color: #ccc;\n      transition: 0.3s; }\n      body form .submit:hover {\n        color: #AAD661;\n        border-color: #AAD661; }\n    body form span {\n      margin-top: 200px;\n      color: red; }\n", ""]);
...
$("document").ready(function () {
  // Get all forms
  var simpleValidation = function simpleValidation() {
